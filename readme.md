...
![Mage keyboard with one side angled inward](cdn.mossx.net/mage_keyboard/mage_stacked.png)
![Mage keyboard halfs side by side](cdn.mossx.net/mage_keyboard/mage_side_by_side.png)
![Mage keyboard plugged into an off screen computer](cdn.mossx.net/mage_keyboard/mage_plugged_in.png)
